      ...
      <div className="max-w-3xl w-full mx-auto px-10">
        ...
        >
          {faqSection.faQitems.map((faq, index) => (
            ...
            >
              <AccordionTrigger className="border bg-white/2 border-border rounded-lg px-4 py-3.5 cursor-pointer no-underline hover:no-underline data-[state=open]:ring data-[state=open]:ring-primary/20">
                {faq.question}
              </AccordionTrigger>
