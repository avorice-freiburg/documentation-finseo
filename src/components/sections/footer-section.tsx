...
export function FooterSection() {
  ...
  return (
    <footer id="footer" className="w-full pb-0">
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between p-10 gap-10">
        <div className="flex flex-col items-start justify-start gap-y-5 max-w-xs lg:max-w-sm">
      ...
      <div className="w-full h-48 md:h-64 relative mt-24 z-0">
        ...
        <div className="absolute inset-0 mx-6">
          <FlickeringGrid
            text={tablet ? "Finseo" : "Streamline your workflow"}
