...
export function ReasoningBasic() {
  const reasoningText = `Based on my analysis of search patterns across platforms, I recommend targeting "AI-powered content optimization" as your primary keyword. This term has high search volume on Google (18K/month) with moderate competition, while also being frequently cited in ChatGPT and Claude responses with 84% positive sentiment.`;
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          >
            <p className="text-sm">
              I need to optimize my content to rank well on both Google and AI platforms like ChatGPT. What keywords should I target for maximum visibility?
            </p>
          </motion.div>
