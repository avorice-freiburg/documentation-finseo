...
import { Download, Share2, FileCode, Upload, X, Bot, PieChart } from "lucide-react";
...
export default function PieChartGenerator() {
  ...
  const [chartType, setChartType] = useState<ChartType>('pie'); // Pre-selected to pie
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error('Could not generate your pie chart. Please specify your data and proportions more clearly.');
      }

      setChartConfig(config);
    } catch (err) {
      console.error('Chart generation error:', err);
      setError('Could not generate your pie chart. Please specify your data and proportions more clearly.');
    } finally {
      setIsLoading(false);
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen w-full">
      ...
      <section className="w-full flex flex-col items-center justify-center gap-10 py-16 relative">
        ...
        <div className="text-center max-w-3xl mx-auto px-6 z-10 pt-16">
          ...
          <h1 className="text-3xl md:text-5xl font-medium tracking-tighter mb-4">
            Create Pie Charts with AI
          </h1>
          <p className="text-muted-foreground text-base md:text-lg">
            Generate professional pie charts to show proportions and parts of a whole in your data. 
      ...
      <section id="pie-chart-generator" className="w-full max-w-4xl mx-auto px-6 -mt-10 mb-16 z-10">
        <div className="rounded-xl bg-card shadow-xl border border-border overflow-hidden">
          <div className="p-6 md:p-8">
            <h2 className="text-2xl font-semibold mb-6 tracking-tight">Generate Your Pie Chart</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Sheet open={isDataSheetOpen} onOpenChange={setIsDataSheetOpen}>
                    ...
                    <SheetContent side="right" className="w-full sm:max-w-lg">
                      <SheetHeader>
                        ...
                        <SheetDescription>
                          Upload a CSV file to use as data for your pie chart
                        </SheetDescription>
                      </SheetHeader>
              ...
              <div>
                <Label htmlFor="chartDescription">Pie Chart Description</Label>
                <Input
                  id="chartDescription"
              ...
              >
                {isLoading ? 'Generating...' : 'Generate Pie Chart'}
              </Button>
            </form>
          </div>
      ...
      <AlertDialog open={showEmbedDialog} onOpenChange={setShowEmbedDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Pie Chart Saved Successfully!</AlertDialogTitle>
            <AlertDialogDescription>
              Your pie chart has been saved and is ready to embed. Use the code below to embed this chart on your website:
            </AlertDialogDescription>
          </AlertDialogHeader>
