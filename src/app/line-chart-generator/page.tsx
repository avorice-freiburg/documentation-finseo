...
import { Download, Share2, FileCode, Upload, X, Bot, TrendingUp } from "lucide-react";
...
export default function LineChartGenerator() {
  ...
  const [chartType, setChartType] = useState<ChartType>('linear'); // Pre-selected to linear
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error('Could not generate your line chart. Please specify your data and trends more clearly.');
      }

      setChartConfig(config);
    } catch (err) {
      console.error('Chart generation error:', err);
      setError('Could not generate your line chart. Please specify your data and trends more clearly.');
    } finally {
      setIsLoading(false);
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen w-full">
        ...
        <div className="text-center max-w-3xl mx-auto px-6 z-10 pt-16">
          <div className="mx-auto flex justify-center">
            <p className="border border-border bg-accent rounded-full text-sm h-8 px-3 flex items-center gap-2 mb-6">
              ...
              AI-Powered Line Chart Generator
            </p>
          </div>
          <h1 className="text-3xl md:text-5xl font-medium tracking-tighter mb-4">
            Create Line Charts with AI
          </h1>
          <p className="text-muted-foreground text-base md:text-lg">
            Generate professional line charts to visualize trends and patterns in your data. 
      ...
      <section id="line-chart-generator" className="w-full max-w-4xl mx-auto px-6 -mt-10 mb-16 z-10">
        <div className="rounded-xl bg-card shadow-xl border border-border overflow-hidden">
          <div className="p-6 md:p-8">
            <h2 className="text-2xl font-semibold mb-6 tracking-tight">Generate Your Line Chart</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Sheet open={isDataSheetOpen} onOpenChange={setIsDataSheetOpen}>
                    ...
                    <SheetContent side="right" className="w-full sm:max-w-lg">
                      <SheetHeader>
                        ...
                        <SheetDescription>
                          Upload a CSV file to use as data for your line chart
                        </SheetDescription>
                      </SheetHeader>
              ...
              <div>
                <Label htmlFor="chartDescription">Line Chart Description</Label>
                <Input
                  id="chartDescription"
              ...
              >
                {isLoading ? 'Generating...' : 'Generate Line Chart'}
              </Button>
            </form>
          </div>
      ...
      <AlertDialog open={showEmbedDialog} onOpenChange={setShowEmbedDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Line Chart Saved Successfully!</AlertDialogTitle>
            <AlertDialogDescription>
              Your line chart has been saved and is ready to embed. Use the code below to embed this chart on your website:
            </AlertDialogDescription>
          </AlertDialogHeader>
