            ...
            <div className="rounded-lg border bg-card p-6">
              <div className="aspect-video bg-muted rounded-lg flex items-center justify-center">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Mentions Tracking Dashboard</p>
                  <p className="text-xs text-muted-foreground">[Image placeholder - showing mention frequency across models and time]</p>
                </div>
              </div>
            </div>
          </section>
