        ...
        <div className="container max-w-4xl mx-auto px-6 py-8 lg:py-12">
          ...
          <div className="space-y-4 pb-8 md:pb-12">
            ...
            <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
              Configure brand name variations to ensure comprehensive <Link href="https://www.finseo.ai/ai-visibility-tracking" className="text-[#0eca7b] hover:underline" target="_blank">AI visibility tracking</Link> across all metrics.
            </p>
          </div>
